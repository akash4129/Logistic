...
st=con.createStatement();
     	...
     	//out.println(queryby);
              	rs=st.executeQuery("select * from empreg");
       if (option.equals("All"))
       {
       	rs=st.executeQuery("select * from empreg");
       	// where cid like "+"'"+queryby+"'");
       }
       else
       {
       	
       	
     		String queryby=request.getParameter("textfield");
     	queryby.trim();
     ;
